...
trait timeTrait
{
    ...
    public function hariKeTgl()
    {
        ...
        switch(strtolower($hari)){
            ...
            default:
                $hari = $date;
        // if($this->getDayFromMessage() == !null){

        //     echo $this->sendResponse("mohon cek kembali nama hari yang anda masukan");
        // }
    ...
    public function dayToHari() //mengubah hari dalam bahasa inggris ke hari dalam bahasa indonesia/sesuai di database
